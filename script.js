...
function submitNumber() {
  ...
  const scriptURL = 'https://script.google.com/macros/s/AKfycbzQxFStBTonX7bL-9_ikWK7-Fq-512QSI5nwpQ9BTtJZ7cYHcVFtO-ovemcGBa-QdM94g/exec' 
...
function showAlert(tabName) {
  ...
  switch (tabName) {
    case 'Home':
      message = "Welkom bij de Nummergenerator. Volg de instructies op het scherm om naar het volgende deel van onze studie te gaan.";
      break;
    case 'Instructions':
      message = "Instructies: Genereer een nummer voor je experiment. Zorg ervoor dat je het nummer onthoudt, omdat je het later nodig zult hebben.";
      break;
    case 'Contact':
      message = "Als je vastzit op deze pagina, neem dan contact met ons op via Prolific en wij zullen zo snel mogelijk hulp bieden.";
      break;
    default:
